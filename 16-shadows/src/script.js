...
const dirationalLightCameraHelper = new THREE.CameraHelper(directionalLight.shadow.camera);
dirationalLightCameraHelper.visible = false;
scene.add(dirationalLightCameraHelper);
/**
 * Materials
 */
...
const tick = () =>
{
    ...
    // sphere.rotation.y = elapsedTime * 1.5;
